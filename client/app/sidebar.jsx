        ...
        return (
            <div className="column col-sm-2 col-xs-1 sidebar-offcanvas" id="sidebar">
                ...
                <ul className="nav hidden-xs" id="lg-menu">
                    ...
                    <li><a href="#"><i className="fa fa-file-text"></i> Orders</a></li>
                    <li><a href="#"><i className="fa fa-group"></i> Customers</a></li>
                ...
                <ul className="list-unstyled hidden-xs" id="sidebar-footer">
                    <li>
                        <a href="http://www.redox-software.co.uk"><h3>simple crm</h3>
                            <i className="fa fa-cloud"></i> redox software ltd</a>
                    </li>
                </ul>

                <ul className="nav visible-xs" id="xs-menu">
                    <li><a href="/" className="text-center"><i className="fa fa-tachometer"></i></a></li>
                    <li><a href="#" className="text-center"><i className="fa fa-file-text"></i></a></li>
                    <li><a href="#" className="text-center"><i className="fa fa-group"></i></a></li>
